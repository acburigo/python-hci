...
class EventPacket:
    ...
    class LE_Subevent(IntEnum):
        ...
        LE_LONG_TERM_KEY_REQUESTED = 0x05
        ...
        LE_DIRECT_ADVERTISING_REPORT = 0x0B
    ...
    class Events(IntEnum):
        ...
        # ATT_FIND_INFORMATION_REQUEST = 0x0504
        ...
        # GAP_LINK_PARAMETER_UPDATE = 0x0607
        ...
        COMMAND_STATUS = 0x067F

    def __init__(self, opcode=None, parameter_total_length=None,
                 parameters=None):
        self.opcode = opcode
        self.parameter_total_length = parameter_total_length
    ...
    def __str__(self):
        return '\n'.join([
            ...
            hex(EventPacket.PACKET_TYPE),
            int(EventPacket.PACKET_TYPE),
            hex(self.opcode),
            int(self.opcode),
    ...
    def from_binary(buffer):
        opcode, parameter_total_length = unpack_from('<BB', buffer, offset=1)

        return EventPacket(
            opcode=opcode,
            parameter_total_length=parameter_total_length,
            parameters=buffer[3:][:parameter_total_length]
        )
